...
const Login = () => {
  ...
  return (
    // Force white background and dark text, ignoring global theme
      ...
      <div className="hidden lg:flex lg:w-7/12 relative flex-col items-center justify-center bg-gradient-to-br from-[#F0F9FF] to-white overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          <div className="animate-fade-in-up opacity-0">
            <span className="text-[#00A9F4] font-bold text-xs tracking-[1px] uppercase">
              Powered by AI
            </span>
          </div>
          ...
          <div className="mt-4 animate-fade-in-up delay-100 opacity-0">
            <div className="animate-float p-7 bg-white rounded-[32px] shadow-[0_10px_40px_rgba(0,169,244,0.15)]">
              <Waves className="w-[72px] h-[72px] text-[#00A9F4]" />
            </div>
          </div>

          <h1 className="mt-8 text-[92px] font-black text-[#00A9F4] tracking-[-4px] leading-tight animate-fade-in-up delay-200 opacity-0">
            wave
          </h1>

          <p className="mt-0 text-lg text-slate-500 font-medium tracking-wide animate-fade-in-up delay-300 opacity-0 max-w-md">
      ...
      <div className="w-full lg:w-5/12 flex items-center justify-center bg-white">
        <div className="max-w-[440px] w-full px-14 flex flex-col items-start">
          <div className="animate-fade-in-up delay-300 opacity-0">
            <h2 className="text-[42px] font-extrabold text-slate-900 leading-[1.1]">
              Welcome back
            </h2>
            <p className="mt-3 text-base text-slate-500 leading-[1.6]">
          ...
          <div className="w-full mt-16 animate-fade-in-up delay-400 opacity-0">
            <button
              ...
              className="group w-full h-[68px] bg-[#1E293B] hover:bg-[#0F172A] rounded-[18px] flex items-center justify-center transition-all duration-300 ease-out hover:shadow-[0_12px_25px_rgba(0,0,0,0.25)] cursor-pointer text-white"
            >
          ...
          <div className="mt-12 w-full animate-fade-in-up delay-500 opacity-0">
            <div className="flex items-start">
              <div className="p-2.5 bg-[#00A9F4]/10 rounded-full mr-4 shrink-0">
                <Lock className="w-[18px] h-[18px] text-[#00A9F4]" />
              </div>
          ...
          <div className="mt-8 w-full text-center animate-fade-in-up delay-500 opacity-0">
            <p className="text-xs text-slate-500">
              ...
              <a href="#" className="text-[#00A9F4] font-bold hover:underline">
                Terms of Service
              </a>{" "}
              and{" "}
              <a href="#" className="text-[#00A9F4] font-bold hover:underline">
